...
- Tier-, Sozial- und Brauchtumsvereine
- Dorffeste, Tage der offenen Tür, Jubiläen und Weihnachtsmärkte

Der typische Entscheider ist Vorstand, Kassier oder Veranstaltungsleitung. Das Kernproblem: Eine analoge Tombola bindet Helfer, erzeugt Bargeld- und Listenaufwand und gibt während des Fests keinen verlässlichen Überblick.

## 3. Leistungsversprechen

**„In 30 Minuten startklar, Loserlöse direkt beim Verein, weniger Listen- und Bargeldchaos.“**

Enthalten sind eine mobile Losauswahl, Reservierung während des Checkouts, Zahlungsbestätigung, Verkaufsstand, Gewinnerexport, QR-Code und ein klarer Abschlussbericht. Die Oberfläche wird pro Verein mit Name, Farbe, Zweck und Gewinnen angepasst.

Vereinsglück ist Softwaredienstleister, nicht Veranstalter und nicht Empfänger der Loserlöse. Der Vertrag und die Benutzeroberfläche müssen diese Rollen durchgängig abbilden.
...
## 6. Ablauf je Veranstaltung

1. Verein bucht und bestätigt seine Rolle als Veranstalter.
2. Verein liefert Name, Zweck, Zeitraum, Losanzahl, Preis, Gewinne, Teilnahmebedingungen und Ansprechpartner.
3. Verein verbindet sein eigenes verifiziertes Zahlungskonto.
4. Vereinsglück richtet eine getrennte Tombola-Instanz ein und führt einen Testkauf im Testmodus durch.
5. Verein gibt Inhalte und Testlauf schriftlich frei.
6. QR-Code wird verteilt; Verkaufsstart und -ende werden protokolliert.
7. Verein führt Ziehung und Gewinnausgabe durch.
8. Export, Aufbewahrung/Löschung und Abschluss werden dokumentiert.

## 7. Recht, Zahlung und Datenschutz

Vor jedem Pilotbetrieb ist eine fachliche Prüfung notwendig. Wesentliche Leitplanken:
...
- Statusseite, Monitoring, Alarmierung, Backup- und Wiederanlaufplan
- barrierearme, responsive Oberfläche
- CSV/PDF-Abschlussbericht ohne unnötige personenbezogene Daten
- dokumentierter Offline-Notfallplan für schwaches Festplatz-WLAN

Der aktuelle lokale Stand ist eine moderne, interaktive Produktdemo plus vorhandener Firebase-/Mollie-Funktionskern. Er ist **noch nicht produktionsbereit**, bis die obigen Sicherheits-, Mandanten-, Rechts- und Live-Zahlungsprüfungen abgeschlossen sind.

## 9. Meilensteine

### Phase 1 – Produkt fertigstellen (2–4 Wochen)

Adminbereich, echte Datenanbindung, Vereinskonfiguration, Rechtstexte-Platzhalter, Security Rules, automatisierte Tests und Testzahlung.

### Phase 2 – Drei Pilotveranstaltungen (4–8 Wochen)

Begleiteter Betrieb, Messung, Fehlerprotokoll und standardisierte Einweisung. Kein unbeaufsichtigter Verkauf.
...
Nach drei Piloten wird nur weiter investiert, wenn:

- Einrichtung im Median unter 60 Minuten liegt,
...
## 11. Offizielle Arbeitsquellen

- Bundesministerium der Justiz, Rennwett- und Lotteriegesetz §§ 26–30: https://www.gesetze-im-internet.de/rennwlottg_2021/
- Bundesministerium der Justiz, § 27 RennwLottDV zu Genehmigung und Steuerbefreiung: https://www.gesetze-im-internet.de/rennwlottgabest/__27.html
- Mollie, aktuelle Gebührenübersicht: https://www.mollie.com/de/pricing

Die Quellen belegen den bundesrechtlichen Rahmen und aktuelle Zahlungsgebühren. Die konkrete Erlaubnis oder Anzeige muss der jeweilige Verein zusätzlich für sein Bundesland und seine Veranstaltung prüfen.
